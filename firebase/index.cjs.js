...
var __toESM = (mod, isNodeMode, target) => (target = mod != null ? __create(
    __getProtoOf(mod)) : {}, __copyProps(
    isNodeMode || !mod || !mod.__esModule ? __defProp(target, 'default',
        {value: mod, enumerable: true}) : target, mod));
var __toCommonJS = (mod) => __copyProps(
    __defProp({}, '__esModule', {value: true}), mod);
...
__export(firebase_exports, {
    ...
    isBrowser: () => isBrowser,
    isNode: () => isNode,
    onRequestFunctionUrl: () => onRequestFunctionUrl,
...
const getFirebaseConfig = (path) => {
    ...
    const conf = __spreadValues(
        __spreadValues({}, (0, import_json.toJSON)(firebaseJsonContent)),
        (0, import_json.toJSON)(firebaseRcContent));
    if (path)
...
const setFirebaseEmulators = (debug) => {
    const fConfig = getFirebaseConfig();
    process.env.GCLOUD_PROJECT = (0, import_get.default)(fConfig,
        'projects.default');
    const authPort = (0, import_get.default)(fConfig, 'emulators.auth.port');
    const functionsPort = (0, import_get.default)(fConfig,
        'emulators.functions.port');
    const firestorePort = (0, import_get.default)(fConfig,
        'emulators.firestore.port');
    const storagePort = (0, import_get.default)(fConfig,
